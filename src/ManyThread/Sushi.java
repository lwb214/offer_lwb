...
public class Sushi {
    ...
    *要求使用多线程实现(可以用线程池，也可以不用*/
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread d1 = new Diners();
        Thread d2 = new Diners();
        Thread d3 = new Diners();
        d1.setName("客人1");d2.setName("客人2");d3.setName("客人2");
        cook.start();
        d1.start();
        d2.start();
        d3.start();
    ...
    static class Cook extends Thread{
        public void make(){
            ...
            System.out.println("做一块寿司,做了"+ curNum.get());
        }
        @Override
        public void run(){
          while (true){
    ...
    static class Diners extends Thread{
        public void eat() throws InterruptedException {
            System.out.println("吃一块寿司,还剩" + curNum.get() );
